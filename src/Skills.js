...
{
    return (
        <div className="container-fluid jumbotron m-2">
        <div className="jumbotron">
            <span className="s1 googlehoverp m-2">Programming Skills</span>
        </div>
        ...
        <div>
        <div className="bar jumbotron bg-light m-2">
            <div className="row">
                <div className="col">
                    <span>C++</span>
                    <div class="progress" style={{height: "20px"}}>
                    <div class="progress-bar" style={{width:"60%",height:"20px",backgroundColor:"rgb(219,68,55)",color:"white"}}>60%</div>
                    </div>
                </div>
                <div className="col">
                    <span>Git</span>
