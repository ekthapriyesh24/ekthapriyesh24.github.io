    ...
    <div className="About container-fluid">
      <div className="row my-5">
        <div id="hl" className="col">
          ...
          <GoogleFlex names="Sophomore" googlehoveropt="googlehover" my="my-5" size="s3"/>
          <GoogleFlex names="IIIT-Allahabad" size="s4" googlehoveropt="googlehover" px="px-1" my="my-3"/>
          </div>
          <div className="googlehoverp m-3">
          <span className="s4">
...
Apart from studies the college has a very good environment for programming and is a boon for programmers.
        ...
        <div id="links" className="googlehoverp col d-flex m-1 flex-column">
          <div className="row">
          ...
          <button type="button" className="m-2 col cc btn btn-outline-success">Codechef</button>
          </a>
          <a href="https://codeforces.com/profile/ekthapriyesh24">
          <button type="button" className="m-2 mx-4 col cf btn btn-outline-primary">Codeforces</button>
          </a>
          </div>
        </div>
      </div>
